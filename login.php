...
?>
        ...
        <section class="text-blueGray-700">
          ...
          ">
                <div class="mt-8">
                  <div class="mt-6">
                    <form action="lcheck.php" method="POST" class="space-y-6">
                      <div>
                        <label for="email" class="block text-sm font-medium text-neutral-600"> Email Id / UserName / Phone number </label>
                        <div class="mt-1">
                      ...
                      <div>
                        <button type="submit" class=" flex items-center justify-center w-full px-10 py-4 text-base font-medium text-center text-white transition duration-500 ease-in-out transform bg-blue-600 rounded-xl hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500
                    "> Sign in </button>
                      </div>
</form>
                    <div>
            ...
            <div class="text-grey-dark mt-6 text-center">
                    ...
                    <a class="no-underline border-b border-blue text-blue" href="/task2/signup.php">
                        Sign up
                    </a>.
                </div>
          </section>
